...
`timescale 1 ns / 1 ps
    ...
    assign enable = s00_axis_tready & s00_axis_tvalid;
    ...
    Sobel_Filter SB(m00_axis_aclk, enable , s00_axis_tdata, data_out);
